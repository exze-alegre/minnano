...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 30, 2024 at 04:42 PM
...
(1, 'Bear Buddy Bestfriend Bayot', 'A soft and cuddly bear plush toy, perfect for kids and collectors.', 500.00, 450.00, 4.80, 'https://via.placeholder.com/255?text=Image+1', 'https://via.placeholder.com/255?text=Image+2', 'https://via.placeholder.com/255?text=Image+3', 564),
(2, 'Unicorn Dream', 'A magical unicorn plush with sparkly horn and rainbow mane.', 700.00, 650.00, 4.90, 'https://via.placeholder.com/255?text=Image+1', 'https://via.placeholder.com/255?text=Image+2', 'https://via.placeholder.com/255?text=Image+3', 392),
(3, 'Panda Pals', 'Adorable panda plush with bamboo accessory.', 299.99, 100.00, 4.70, 'https://via.placeholder.com/255?text=Image+1', 'https://via.placeholder.com/255?text=Image+2', 'https://via.placeholder.com/255?text=Image+3', 570),
(4, 'Kitty Cuddles', 'A small kitten plush with a playful pose.', 400.00, 380.00, 4.50, 'https://via.placeholder.com/255?text=Image+1', 'https://via.placeholder.com/255?text=Image+2', 'https://via.placeholder.com/255?text=Image+3', 470),
(5, 'Bunny Hop', 'Cute bunny plush with floppy ears and soft fur.', 600.00, 580.00, 4.60, 'https://via.placeholder.com/255?text=Image+1', 'https://via.placeholder.com/255?text=Image+2', 'https://via.placeholder.com/255?text=Image+3', 343),
(6, 'Dragon Puff', 'A fierce but friendly dragon plush with detailed wings.', 299.99, 200.00, 3.80, 'https://via.placeholder.com/255?text=Image+1', 'https://via.placeholder.com/255?text=Image+2', 'https://via.placeholder.com/255?text=Image+3', 306),
(7, 'Foxy Friend', 'Charming fox plush with a bushy tail and sly expression.', 520.00, 500.00, 4.40, 'https://via.placeholder.com/255?text=Image+1', 'https://via.placeholder.com/255?text=Image+2', 'https://via.placeholder.com/255?text=Image+3', 502),
(8, 'Elephant Hugs', 'A large elephant plush toy with soft gray fur.', 1200.00, 1100.00, 4.80, 'https://via.placeholder.com/255?text=Image+1', 'https://via.placeholder.com/255?text=Image+2', 'https://via.placeholder.com/255?text=Image+3', 391),
(9, 'Giraffe Giggles', 'A tall, soft giraffe plush with big eyes and a playful smile.', 750.00, 700.00, 4.85, 'https://via.placeholder.com/255?text=Image+1', 'https://via.placeholder.com/255?text=Image+2', 'https://via.placeholder.com/255?text=Image+3', 452),
(10, 'Koala Kuddles', 'A cute and soft koala plush with a eucalyptus leaf.', 500.00, 450.00, 4.70, 'https://via.placeholder.com/255?text=Image+1', 'https://via.placeholder.com/255?text=Image+2', 'https://via.placeholder.com/255?text=Image+3', 483),
(11, 'Lion King', 'A majestic lion plush with a golden mane and fierce eyes.', 950.00, 900.00, 4.80, 'https://via.placeholder.com/255?text=Image+1', 'https://via.placeholder.com/255?text=Image+2', 'https://via.placeholder.com/255?text=Image+3', 460),
(12, 'Zebra Zing', 'A black and white striped zebra plush with a unique design.', 600.00, 550.00, 4.60, 'https://via.placeholder.com/255?text=Image+1', 'https://via.placeholder.com/255?text=Image+2', 'https://via.placeholder.com/255?text=Image+3', 553),
(13, 'Crocodile Crunch', 'A tough but friendly crocodile plush with an engaging grin.', 650.00, 600.00, 4.55, 'https://via.placeholder.com/255?text=Image+1', 'https://via.placeholder.com/255?text=Image+2', 'https://via.placeholder.com/255?text=Image+3', 484),
(14, 'Penguin Pals', 'A pair of adorable penguin plushies with cozy scarves.', 800.00, 750.00, 4.90, 'https://via.placeholder.com/255?text=Image+1', 'https://via.placeholder.com/255?text=Image+2', 'https://via.placeholder.com/255?text=Image+3', 460),
(15, 'Monkey Mischief', 'A playful monkey plush with a cheeky smile.', 700.00, 650.00, 4.70, 'https://via.placeholder.com/255?text=Image+1', 'https://via.placeholder.com/255?text=Image+2', 'https://via.placeholder.com/255?text=Image+3', 549),
(16, 'Teddy Bear Deluxe', 'A premium teddy bear plush with a soft, velvety coat.', 1200.00, 1100.00, 4.95, 'https://via.placeholder.com/255?text=Image+1', 'https://via.placeholder.com/255?text=Image+2', 'https://via.placeholder.com/255?text=Image+3', 462),
(17, 'Rabbit Snuggles', 'A fluffy white rabbit plush with floppy ears.', 500.00, 480.00, 4.60, 'https://via.placeholder.com/255?text=Image+1', 'https://via.placeholder.com/255?text=Image+2', 'https://via.placeholder.com/255?text=Image+3', 366),
(18, 'Fox Fables', 'A soft fox plush with a warm and inviting expression.', 450.00, 420.00, 4.50, 'https://via.placeholder.com/255?text=Image+1', 'https://via.placeholder.com/255?text=Image+2', 'https://via.placeholder.com/255?text=Image+3', 443),
(19, 'Polar Bear Pal', 'A large and cuddly polar bear plush perfect for hugs.', 1000.00, 950.00, 4.80, 'https://via.placeholder.com/255?text=Image+1', 'https://via.placeholder.com/255?text=Image+2', 'https://via.placeholder.com/255?text=Image+3', 519),
(20, 'Sloth Snuggler', 'A relaxing sloth plush with long limbs for extra comfort.', 800.00, 750.00, 4.75, 'https://via.placeholder.com/255?text=Image+1', 'https://via.placeholder.com/255?text=Image+2', 'https://via.placeholder.com/255?text=Image+3', 365);
...
--
ALTER TABLE `basket_items`
  MODIFY `basket_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=148;
