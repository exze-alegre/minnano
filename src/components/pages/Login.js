...
const Login = () => {
  ...
  {/* Body */}
<Row
  className="flex-grow-1 justify-content-center align-items-center body-row"
>
  ...
  <div className="login-right">
    <div className="login-form" style={{ backgroundColor: "#D96565", padding: "20px", borderRadius: "8px" }}>
      <h2>{isRegister ? "Register" : "Login"}</h2>
      {error && <p className="error" style={{ color: 'white' }}>{error}</p>}
      <form onSubmit={handleSubmit}>
        <div className="form-group">
          <label htmlFor="username" className="d-block text-start" style={{ marginBottom: "5px" }}>Username</label>
          <input
            type="text"
            id="username"
            value={username}
        ...
        <div className="form-group">
          <label htmlFor="password" className="d-block text-start" style={{ marginBottom: "5px" }}>Password</label>
          <input
            type="password"
            id="password"
            value={password}
        ...
        <div className="text-center">
          <button type="submit" disabled={loading} style={{ width: "100%", padding: "10px", backgroundColor: "#fff", borderRadius: "4px", border: "none" }}>
